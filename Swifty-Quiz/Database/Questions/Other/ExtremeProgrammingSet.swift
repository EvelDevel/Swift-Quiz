...
class ExtremeProgrammingSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Кто является основным разработчиком методологии Extreme Programming?"],
                     image: "",
                     optionA: "Кент Бек",
            ...
            Question(question: ["Должны ли все члены команды в ходе работы соблюдать требования общих стандартов оформления кода (extreme programming)?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
            ...
            Question(question: ["Написание автоматических тестов, позволяющее проверить на корректность отдельные модули исходного кода"],
                     image: "",
                     ...
                     optionD: "",
                     questionId: 3010,
                     helpText: "XP предполагает написание автоматических тестов (программный код, написанный специально для того, чтобы тестировать логику другого программного кода). Особое внимание уделяется двум разновидностям тестирования: юнит-тестирование модулей; функциональное тестирование. Модульное тестирование, иногда блочное тестирование или юнит-тестирование — процесс в программировании, позволяющий проверить на корректность отдельные модули исходного кода программы. Тесты модулей (юнит-тесты) позволяют разработчикам убедиться в том, что каждый из них по отдельности работает корректно. Они также помогают другим разработчикам понять, зачем нужен тот или иной фрагмент кода, и как он функционирует — в ходе изучения кода тестов логика работы тестируемого кода становится понятной, так как видно, как он должен использоваться. Тесты модулей также позволяют разработчику без каких-либо опасений выполнять рефакторинг (refactoring)."),

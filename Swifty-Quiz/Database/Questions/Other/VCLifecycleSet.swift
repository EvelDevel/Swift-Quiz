...
class VCLifecycleSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["После какого этапа жизненного цикла у нас начинают устанавливаться свойства и аутлеты?"],
                     image: "",
            ...
            Question(question: ["К какому этапу жизненного цикла у нас будут проиниализированы все свойства хранения и аутлеты?"],
                     image: "",
            ...
            Question(question: ["Можем ли мы обращаться к свойствам и аутлетам в методе viewDidLoad()?",
                     ...
                     helpText: "В методе viewDidLoad() мы выполняем большинство настроек для нашего вью контроллера, так как в этот момент все свойства и аутлеты уже инициализированы (значит к ним можно обращаться и менять их параметры). Все свойства инициализируются между awakeFromNib и loadView (то есть успевают до viewDidLoad)."),

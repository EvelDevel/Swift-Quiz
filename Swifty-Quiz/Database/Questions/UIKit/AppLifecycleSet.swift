...
final class AppLifecycleSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["При деактивации приложения, должны ли мы перевести его в \"тихое состояние\" (сохранить пользовательские данные на диск и закрыть все открытые файлы)?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["При переходе к какому состоянию вам необходимо завершить все важные задачи и освободить как можно больше памяти (при поддержке UIWindowSceneDelegate)?"],
                     image: "",
                     optionA: "Background",

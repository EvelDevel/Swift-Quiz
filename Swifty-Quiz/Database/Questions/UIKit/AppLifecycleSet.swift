...
final class AppLifecycleSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["При деактивации приложения, должны ли мы перевести его в \"тихое состояние\" (то есть сохранить пользовательские данные на диск и закрыть все открытые файлы)?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",

...
class BehavioralPatternsSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Самый простой, но наименее желательный способ реализации паттерна Observer?",
                                "Способ реализации паттерна Observer, который нарушает абстракцию, усложняет код для чтения и поддержки?",

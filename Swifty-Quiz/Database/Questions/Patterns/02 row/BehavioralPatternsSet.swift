...
class BehavioralPatternsSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Поведенческий паттерн проектирования, который даёт возможность последовательно обходить элементы составных объектов, не раскрывая их внутреннего представления",
                                "Какой поведенческий паттерн проектирования даёт возможность последовательно обходить элементы составных объектов, не раскрывая их внутреннего представления?"],
                     image: "",
                     optionA: "Итератор",
                     optionB: "Посредник",
                     optionC: "Наблюдатель",
            ...
            Question(question: ["Поведенческий паттерн проектирования, который создаёт механизм подписки, позволяющий одним объектам следить и реагировать на события, происходящие в других объектах.",
                                "Какой паттерн создаёт механизм подписки, позволяющий одним объектам следить и реагировать на события, происходящие в других объектах?"],
                     image: "",
                     optionA: "Наблюдатель",
                     optionB: "Снимок",
                     optionC: "Посетитель",

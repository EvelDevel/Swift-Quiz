    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Какой паттерн изображен на картинке?",
                                "На изображении показан именно этот шаблон проектирования",
                                "Какой шаблон показан на изображении?"],
                     image: "BasicPatterns32",
                     optionA: "Adapter",
                     optionB: "Singleton",
                     optionC: "Visitor",
                     optionD: "Flyweight",
            ...
            Question(question: ["Порождающий шаблон проектирования, который позволяет скрыть внутри себя создание сложного объекта",
                                ...
                                "Этот паттерн проектирования имеет один метод с входными параметрами, которые определяют, как и какой будет создаваться сложный объект"],
                     image: "",
                     optionA: "Factory",
                     optionB: "Visitor",
                     optionC: "Proxy",

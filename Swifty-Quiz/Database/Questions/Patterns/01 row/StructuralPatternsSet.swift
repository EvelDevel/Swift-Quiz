    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Какой паттерн необходимо использовать, когда вы хотите использовать сторонний класс, но его интерфейс не соответствует остальному коду приложения?",
                                "Какой паттерн будем использовать, когда нужно использовать несколько существующих подклассов, но в них не хватает какой-то общей функциональности, причем расширить суперкласс вы не можете?"],
                     image: "",
                     optionA: "Adapter",
                     optionB: "Bridge",
                     optionC: "Decorator",

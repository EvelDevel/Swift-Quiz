    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["С какой буквы должно начинаться имя переменной в Swift?",
                                ...
                                "С какой буквы мы пишем именя переменных или констант в Swift?"],
                     image: "",
                     optionA: "С маленькой",
                     optionB: "С заглавной",
                     optionC: "С Греческой",
            ...
            Question(question: ["Можем ли мы менять значение переменной?",
                     ...
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "Да, но только внутри функции",
                     optionD: "Нет, как и у константы",
                     correctAnswer: 1,
                     questionId: 4,
            ...
            Question(question: ["Переменная, значение которой можно установить только один раз и нельзя изменить в дальнейшем",
                     ...
                     image: "",
                     optionA: "Неизменяемая переменная",
                     optionB: "Постоянная",
                     optionC: "Константа",
                     optionD: "Одинарная переменная",
                     correctAnswer: 3,
                     questionId: 5,
            ...
            Question(question: ["Можем ли мы передать опциональный String куску кода, который ожидает неопциональный String?",
                                "Можете ли вы передать опциональный тип Double куску кода, который ждет неопциональный тип?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "Только внутри структуры",
                     optionD: "Только внутри цикла",
                     correctAnswer: 2,
                     questionId: 44,
            ...
            Question(question: ["Можем ли мы после объявления константы, дальше по коду изменить ее на переменную?",
                     ...
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "Только константу",
                     optionD: "Только переменную",
                     correctAnswer: 2,
                     questionId: 47,
            ...
            Question(question: ["Один случай, когда в Swift необходимо ставить точку с запятой (;) в коде?",
                     ...
                     optionB: "При создании двух переменных",
                     optionC: "Несколько выражений на строке",
                     optionD: "Таких случаев нет",
                     correctAnswer: 3,
                     questionId: 50,
            ...
            Question(question: ["Как изменить имя существующего типа на более подходящее по контексту?",
                     ...
                     optionB: "Использовать двойные кавычки",
                     optionC: "Никак",
                     optionD: "Создать другую переменную",
                     correctAnswer: 1,
                     questionId: 52,
            ...
            Question(question: ["Если мы точно уверены, что опционал имеет значение, как мы можем его получить?",
                                "Каким образом мы можем получить значение опционала, если уверены, что оно есть?",
                                "Как получить значение опционала, если значение точно есть?"],
                     image: "",

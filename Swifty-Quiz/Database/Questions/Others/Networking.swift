        ...
        return [
            ...
            Question(question: [
                ...
                "Можем ли мы получить ответ от сервера в формате json?",
                     ...
                     helpText: """
                     Да. Оба этих формата могут использоваться для отправки информации с сервера. Мобильным приложениям редко приходится работать с html-данными. Это, скорее, исключительный случай, когда вы хотите взаимодействовать с сайтом, который для этого не предназначен.

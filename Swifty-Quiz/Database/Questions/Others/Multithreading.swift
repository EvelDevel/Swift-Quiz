        ...
        return [
            ...
            Question(question: [
                "Можем ли мы использовать многопоточность для разграничение групп задач, изолируя их друг от друга на разные потоки по типу задачи?"
                     ...
                     helpText: """
                     Есть несколько общих обстоятельств, которые делают использование нескольких потоков очевидным: Разграничение групп задач: потоки могут использоваться для обеспечения модульности приложения.
            ...
            Question(question: [
                "Могут ли несколько потоков быть использованы для параллельного выполнения копий одной и той же задачи?"
                     ...
                     helpText: """
                     Есть несколько общих обстоятельств, которые делают использование нескольких потоков очевидным: Распараллеливание вычислений - несколько потоков могут быть использованы для параллельного выполнения копий одной и той же задачи на подмножестве исходных данных.
                     """),

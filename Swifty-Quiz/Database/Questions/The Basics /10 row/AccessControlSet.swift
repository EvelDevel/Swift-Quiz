    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Где может быть использован класс с уровнем доступа fileprivate?",
                                "Класс с уровнем доступа filprivate можно использовать там"],
                     image: "",
            ...
            Question(question: ["Можете ли вы явно указать уровень додступа для кортежа?",
            ...
            Question(question: ["Можем ли мы таким образом прееписать метод и сделать его более доступным?"],
            ...
            Question(question: ["Могут ли свойства быть более открытыми, чем их тип?",
                     ...
                     correctAnswer: 1,
                     questionId: 2328,
                     helpText: "Константы, переменные, свойства не могут быть более открытыми, чем их тип. Это не правильно писать свойство public для private типа. Аналогично дело обстоит и с сабскриптом: сабскрипт не может быть более открытым, чем тип индекса или возвращаемый тип."),

	...
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: ["Какое ключевое слово используется для вычисляемых свойств класса, вместо static?"],
					 ...
					 optionC: "public",
					 optionD: "",
					 questionId: 569227571,
					 helpText: "Для вычисляемых свойств самого класса, вы должны использовать ключевое слово class вместо static, чтобы разрешать подклассам переопределение инструкций суперкласса"),

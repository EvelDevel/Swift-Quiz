    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Сколько логических операторов являются инфиксными?",
                     ...
                     optionC: "3",
                     optionD: "Все",
                     questionId: 374470720,
                     helpText: "2. Инфиксными являются два логических оператора: && (И) и || (ИЛИ)."),

    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Какой результат возвращает оператор проверки типа is?",
                                ...
                                "Какой тип результата будет после првоерки типа через оператор is?"],
                     image: "",
            ...
            Question(question: ["Какую форму оператора необходимо использовать, когда мы не уверены, что наше понижаюшее приведение выполнится успешно?",
            ...
            Question(question: ["Какие псевдоними для работы с неопределенными типами есть в Swift?",

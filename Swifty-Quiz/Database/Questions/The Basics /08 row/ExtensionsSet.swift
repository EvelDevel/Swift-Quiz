    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Как \"Расширения\" будет по английски?"],
                     ...
                     correctAnswer: 1,
                     questionId: 2001,
                     helpText: "Праильный ответ: Extensions."),
            ...
            Question(question: ["Как называется процесс добавления нового функционала классам, к исходныму коду которых нет доступа?"],
                     image: "",
            ...
            Question(question: ["С помощью расширения мы можем переписать существующую функциональность типа. Так ли это?",
                                ...
                                "С помощью раширения мы можем только переписать существующую функциональность, но не добавить новую. Так ли это?"],
                     image: "",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "",

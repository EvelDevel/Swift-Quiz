    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Мы используем двойной вопросительный знак ?? именно для этого"],
                     ...
                     optionD: "",
                     questionId: 240633108,
                     helpText: "Оператор объединения по nil (a ?? b) извлекает опционал a, если он содержит значение, или возвращает любое дефолтное значение b (которое вы укажете), если a равно nil. Выражение a может быть только опционалом. Выражение b должно быть такого же типа, что и значение внутри a."),

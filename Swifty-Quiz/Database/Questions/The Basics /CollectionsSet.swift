    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Какая из этих строк создаст массив, словарь, или кортеж?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 357650604,
                     helpText: "В первой строке мы создаем кортеж, во второй у нас будет ошибка компиляции, поскольку мы не можем создать словарь таким образом, без круглых скобок после указания типа словаря. Корректная запись будет выглядеть так: var counter = [String: Double]()."),
            ...
            Question(question: ["Корректен ли данный код работы с массивом в Swift?"],
                     ...
                     helpText: "Swift не поддерживает такое поведение массивов, добавлять или убирать элементы необходимо через нативные функции, такие как .append, .remove и так далее. В нашем случае - мы получим ошибку компиляции (No exact matches in call to subscript)."),

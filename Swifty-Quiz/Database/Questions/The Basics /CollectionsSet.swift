...
class CollectionsSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["В результате фильтрации словаря через .filter мы получим новую коллекцию элементов?",
                                "При фильтрации словаря через .filter старая коллекция остается неизменной. Так ли это?",

...
class GenericsSet {
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: [
                "Выберите вариант с корректным ограничением типа, когда мы требуем чтобы параметр был подклассом другого класса"
            ],
					 image: "",
					 optionA: "<T: SomeClass>",
					 optionB: "<T> - SomeClass",

    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Обработка ошибок, это процесс...?"],
                     ...
                     optionD: "Прогноризрования ошибок",
                     correctAnswer: 1,
                     questionId: 1502,
            ...
            Question(question: ["Во время генерации ошибки, за что отвечает код, окружающий ошибку?",
                     ...
                     image: "",
                     optionA: "Оработка ошибки",
                     optionB: "Запись ошибки в лог",
                     optionC: "Удаление ошибки",
                     optionD: "Прогнозирование",
                     correctAnswer: 1,
                     questionId: 1506,
                     helpText: "Когда генерируется ошибка, то фрагмент кода, окружающий ошибку, должен быть ответственным за ее обработку: например, он должен исправить ее, или испробовать альтернативный подход, или просто информировать пользователя о неудачном исполнении кода."),
            ...
            Question(question: ["Могут ли генерирующие ошибку инициализаторы распространять ошибки так же, как генерирующие функции?",
                                "Генерирующие функции и генерирующий иницализаторы могут одинаковым образом передавать ошибки, так ли это?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["Каким будет значение выражения, если мы используем try cо знаком вопроса (try?) и получаем ошибку?",

...
class InitializationSet {
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: ["Сокращенный способ инициализировать свойства нового экземпляра структуры",
					 ...
					 helpText: "Почленный инициализатор - сокращенный способ инициализировать свойства нового экземпляра структуры. Начальные значения для свойств нового экземпляра могут быть переданы в почленный инициализатор по имени."),
			...
			Question(question: ["Какая фаза инициализации для гипотетического подкласса и суперкласса на изображении?",

		...
		return [
			...
			Question(question: [
                ...
                "Чтобы убедиться, что двухфазная инициализация прошла без ошибок, Swift проводит такое количество проверок (каждый раз)"
                     ...
                     1: Назначенный инициализатор убеждается, что все свойства его класса инициализированы до того, как он делегирует их наверх в суперкласс.
                     
                     2: Он же должен делегировать суперклассу инициализатор до присваивания значений унаследованным свойствам.
                     
                     3: Вспомогательный инициализатор делегирует другому инициализатору до того, как будут присвоены значения любым свойствам.
			...
			Question(question: [
                ...
                "К какой фазе инициализации относятся эти пункты: \"Назначенный инициализатор для этого класса подтверждает, что все свойства, представленные этим классом, имеют значения\"?"
                     ...
                     helpText: """
                     К первой фазе. Назначенный или вспомогательный инициализатор вызывается, память под экземпляр выделяется, но она еще не инициализирована.

		...
		return [
			...
			Question(question: [
                ...
                "При инициализации нового экземпляра структуры, мы можем воспользоваться этим инициализатором"
					 ...
					 image: "",
					 optionA: "Почленный инициализатор (Memberwise)",
					 optionB: "Дефолтный инициализатор (Default)",
					 optionC: "Деинициализатор (deinit)",
					 optionD: "",
					 questionId: 757192982,
					 helpText: "Почленный инициализатор (Memberwise). Почленный инициализатор - это сокращенный способ инициализировать свойства нового экземпляра структуры. Начальные значения для свойств нового экземпляра могут быть переданы в почленный инициализатор по имени."),
			...
			Question(question: [
                "Сколько вспомогательных инициализаторов (Convenience init) имеет суперкласс?",
                "Сколько назначенных инициализаторов (Designated init) имеет подкласс?"
            ],

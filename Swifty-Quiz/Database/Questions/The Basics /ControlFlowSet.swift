    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Сколько разновидностей цикла поддерживает Swift?",
                                "Swift поддерживает столько разновидностей цикла"],
                     image: "",
                     optionA: "3",
                     optionB: "2",
                     optionC: "1",
                     optionD: "",
                     questionId: 784476212,
                     helpText: "3. Свифт поддерживает циклы: for-in, while и repeat-while."),
            
            Question(question: ["Цикл for-in может использоваться для этого",
                     ...
                     optionD: "",
                     questionId: 719442268,
                     helpText: "Итерация элементов коллекции. Цикл for-in используется для итерации по коллекциям элементов, таких как диапазоны чисел, элементы массива или символы в строке."),
            ...
            Question(question: ["При итерации какой коллекции, мы можем разложить вернувшееся значение на отдельные константы?",
                     ...
                     optionC: "Массив",
                     optionD: "",
                     questionId: 866581774,
                     helpText: """
                     Словарь. Вы можете производить итерацию по словарю, чтобы получить доступ к его паре ключ-значение.
                     
                     Когда происходит итерация по словарю, каждый его элемент возвращается как кортеж (ключ, значение). Вы можете разложить члены кортежа на отдельные константы для того, чтобы использовать их в теле цикла for-in.
                     """),
            ...
            Question(question: ["В этом цикле index является переменной или константой?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 400017104,
                     helpText: "Константа. В примере index является константой, значение которой автоматически устанавливается в начале каждой итерации цикла. Как таковую, ее не нужно объявлять перед использованием. Ее объявление неявно происходит в объявлении цикла, без необходимости использования зарезервированного слова let."),
            ...
            Question(question: ["Какие значения мы получим в консоль?",
                     ...
                     optionC: "2, 4, 6, 8",
                     optionD: "4, 6",
                     questionId: 370385521,
                     helpText: "2, 4, 6. Чтобы у нас была возможность пропустить ненужные интервалы диапазона, используйте функцию stride(from:to:by:). Данная функция не захватывает последнее значение диапазона (8)."),
            ...
            Question(question: ["Какие значения данный метод выведет в консоль?",
                     ...
                     optionC: "2, 4, 6",
                     optionD: "4, 6, 8",
                     questionId: 459631047,
                     helpText: "2, 4, 6, 8. Вы можете работать и с закрытыми диапазонами, но уже при помощи метода stride(from:through:by:). \"through\" внутри данного метода говорит нам о том, что последнее значение диапазона будет захвачено и выведено в консоль."),
            ...
            Question(question: ["Первая итерация цикла while будут выполняться только в этом случае",
                     ...
                     optionD: "",
                     questionId: 390785467,
                     helpText: "Условие цикла истинно. Цикл while начинается с вычисления условия. Если условие истинно, то инструкции в теле цикла будут выполняться до тех пор, пока оно не станет ложным."),
            ...
            Question(question: ["Первая итерация цикла repeat-while будут выполняться только в этом случае",
                     ...
                     optionD: "",
                     questionId: 774033567,
                     helpText: "В любом случае. repeat-while всегда выполняет одну итерацию до того, как происходит проверка условия. Затем цикл продолжает повторяться до тех пор, пока условие не станет false."),
            ...
            Question(question: ["Swift предоставляет нам два варианта добавить условные ответвления кода, при помощи инструкции if и инструкции switch, какую логично использовать, когда условие простое?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 690136287,
                     helpText: """
                     Инструкцию if. Swift предоставляет нам два варианта добавить условные ответвления кода - это при помощи инструкции if и при помощи инструкции switch.
            ...
            Question(question: ["В каком случае инструкция if выполнит установленные инструкции?",
                     ...
                     optionC: "В любом случае",
                     optionD: "",
                     questionId: 399204058,
                     helpText: "Условие true. В самой простой своей форме инструкция if имеет всего одно условие if. Эта инструкция выполняет установленные инструкции только в случае, когда условие true."),
            ...
            Question(question: ["Если в инструкции if условие будет равно false, можно использовать это ключевое слово",
                     ...
                     optionC: "another",
                     optionD: "but",
                     questionId: 681827171,
                     helpText: "else. Инструкция if может предусматривать еще один дополнительный набор инструкций в ветке известной как оговорка else, которая нужна в случае, если условие false. Эти инструкции указываются через ключевое слово else."),
            ...
            Question(question: ["Если внутри инструкции switch, при сравнении по шаблонам, мы нашли совпадение - пройдет ли сравнение дальше, по остальным шаблонам?",
                     ...
                     optionD: "",
                     questionId: 807800181,
                     helpText: """
                     Нет. Инструкция switch подразумевает наличие какого-то значения, которое сравнивается с несколькими возможными шаблонами.
                     
                     После того как значение совпало с каким-либо шаблоном, выполняется код, соответствующий ответвлению этого шаблона, и больше сравнений уже не происходит. Switch представляет собой альтернативу инструкции if, отвечающей нескольким потенциальным значениям.
                     """),
            ...
            Question(question: ["Случай default, внутри инструкции switch, является обязательным?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 261699799,
                     helpText: """
                     Нет. Каждая инструкция switch должна быть исчерпывающей. То есть это значит, что каждое значение обязательно должно находить совпадение с шаблоном в каком-либо случае (case).
                     
                     Если неудобно вписывать все возможные варианты случаев, то вы можете определить случай по умолчанию, который включает в себя все значения, которые не были включены в остальные случаи. Такой случай по умолчанию называется default, и он всегда идет после всех остальных случаев.
                     """),
            
            Question(question: ["Получим ли мы Success в консоль?"],
                     image: "ControlFlow09",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "",
                     optionD: "",
                     questionId: 876251113,
                     helpText: """
                     ...
                     Нижнее подчеркивание может ставится в любом месте вашего числа, оно используется исключительно для красоты.
                     """),
            ...
            Question(question: ["Напечатается ли наша строка в консоль хотя бы раз?"],
                     image: "ControlFlow20",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
                     optionD: "",
                     questionId: 176637884,
                     helpText: "Да. Когда наша переменная counter будет равна 6 - мы зайдем внутрь цикла while, прибавим 2, и получим проходное значение для условия if counter == 8, распечаем строку \"Удачи в изучении!\" и в следующей итерации уже не попадем на новый круг, потому что с 8 не пройдем проверку while counter < 8."),
            ...
            Question(question: ["Получим ли мы строки в консоль? Если да, то сколько?"],
                     image: "ControlFlow19",
                     optionA: "4",
                     optionB: "5",
                     optionC: "Столкнемся с ошибкой",
                     optionD: "Цикл будет бесконечным",
                     questionId: 652050274,
                     helpText: "4. Мы выполним данный цикл repeat всего один обязательный раз, который заложен в реализацию цикла repeat - while. Внутри него мы один раз запустим цикл for-in, состоящий из 4 итераций, которые напечатают нам 4 строчки Hello!"),
            ...
            Question(question: ["Чем разделяются значения внутри составного case в инструкции switch?",
                     ...
                     questionId: 731956651,
                     helpText: "Запятая. Для того, чтобы switch с одним кейсом подходил под \"a\" и \"A\",объедините два значения в один составной кейс, разделив значения запятыми."),
            ...
            Question(question: ["Если при проверке по switch-case ваше значение совпадает с несколькими проверяемыми шаблонными, как поведет себя инструкция в таком случае?",
                     ...
                     optionD: "",
                     questionId: 971188272,
                     helpText: """
                     Исполнит первое совпадение. В отличии от C, инструкция switch в Swift позволяет множественное совпадение или пересечение значений нескольких случаев.
            ...
            Question(question: ["Что мы получим, запустив данный код?"],
                     image: "ControlFlow11",
                     optionA: "Ошибку компиляции",
                     optionB: "Success",
                     optionC: "Failure",
                     optionD: "",
                     questionId: 613478671,
            ...
            Question(question: ["Что выводится в консоль?"],
                     ...
                     optionC: "default",
                     optionD: "",
                     questionId: 968046514,
                     helpText: "9. Кейс выше имеет два шаблона: (let x, 0) и (0, let x). И тот и другой шаблон включают в себя привязку для x и x является целочисленным значением для двух этих шаблонов, что значит, что код внутри тела кейса всегда будет иметь доступ к значению x."),
            ...
            Question(question: ["Сколько операторов передачи управления есть в Swift?",
                     ...
                     optionC: "Три",
                     optionD: "Два",
                     questionId: 482019043,
                     helpText: "Пять. Операторы передачи управления меняют последовательность выполнения вашего кода, передавая управление от одного фрагмента кода другому. В Swift есть пять операторов передачи управления: continue, break, fallthrough, return, throw."),
            ...
            Question(question: ["Получим ли мы фразу \"Мы нашли его!\" в консоль?"],
                     image: "ControlFlow21",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
                     optionD: "",
                     questionId: 440246012,
            ...
            Question(question: ["Этот оператор управления останавливает выполнение всей инструкции управления потоком",
                     ...
                     optionC: "fallthrough",
                     optionD: "return",
                     questionId: 343910356,
                     helpText: "break. Оператор break останавливает выполнение всей инструкции управления потоком. Оператор break может быть использован внутри инструкции switch или внутри цикла, когда вы хотите остановить дальнейшее выполнение switch или цикла раньше, чем он должен закончиться сам по себе."),
            
            Question(question: ["Какой из циклов мы остановим через выполнение break generalLoop?"],
                     image: "ControlFlow15",
                     optionA: "Оба цикла",
                     optionB: "Только родительский",
                     optionC: "Вложенный",
                     optionD: "",
                     questionId: 376464372,
                     helpText: """
            ...
            Question(question: ["Позволит ли Swift таким образом использовать цикл for-in?"],
                     image: "ControlFlow03",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "",
                     optionD: "",
                     questionId: 504035071,
                     helpText: "Нет. Мы не сможем перечислять значения через запятую. Xcode будет ругаться на первую запятую, и выдаст ошибку компиляции \"Expected '{' to start the body of for-each loop\"."),
            ...
            Question(question: ["Что мы получим в консоль?"],
                     ...
                     optionC: "Столкнемся с ошибкой",
                     optionD: "",
                     questionId: 257119172,
                     helpText: "Other city. Мы получим Other city в консоль. Поскольку мы не прошли первую проверку (получили false) и попали в блок else."),
            ...
            Question(question: ["Чтобы проигнорировать какой-либо кейс в switch, мы можем написать в теле кейса комментарий, так ли это? Если нет, что произойдет?",
                     ...
                     optionD: "",
                     questionId: 331088721,
                     helpText: "Ошибка компиляции. Кейс в инструкции switch, который содержит только комментарий, при компиляции выдает ошибку компиляции. Комментарии - это не утверждения, и они не дают возможности игнорировать кейсы. Если вы хотите игнорировать кейс switch, используйте break."),
            ...
            Question(question: ["Можем ли мы создавать вложенные циклы?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 941402221,
                     helpText: "Да. Вы можете размещать циклы или инструкции switch внутри других циклов или switch инструкций, создавая тем самым сложное течение исполнения кода. Однако циклы и инструкции switch могут иметь break, что может прервать выполнение кода преждевременно."),
            
            Question(question: ["Этот цикл выведет нам 10 строк кода. Так ли это?"],
                     image: "ControlFlow16",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "",
                     optionD: "",
                     questionId: 544411768,
            ...
            Question(question: ["Инструкция guard выполняет код внутри скобок только тогда, когда ее условие...?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 884692904,
                     helpText: """
                     false. Инструкция guard, как и инструкция if, выполняет выражения в зависимости от логического значения условия. Используйте guard, чтобы указать на то, что условие обязательно должно быть true, чтобы код после самой инструкции guard выполнился.
            ...
            Question(question: ["Сколько строк кода мы получим в консоль?"],
                     ...
                     optionC: "8",
                     optionD: "",
                     questionId: 324123682,
                     helpText: "3. Это задание на внимательность, мы получим 3 строки. Внутри самого цикла мы получим 2 строчки \"We got our number\", но перед циклом мы выполним print(\"We start looping\"), в которой распечатаем еще одну строку."),
            ...
            Question(question: ["Если условие инструкции guard выполнилось, будет ли исполняться кода внутри фигурных скобок?",
                     ...
                     Эта ветка должна перебросить исполнение кода на выход из этого блока кода, в котором был определен guard. А сделать это можно при помощи инструкций return, break, continue, throw или можно вызвать метод, который ничего не возвращает, например fatalError(_file:line:).
                     """),
            
            Question(question: ["Сколько строк кода напечатает данный цикл?"],
                     image: "ControlFlow17",
                     optionA: "5",
                     optionB: "4",
                     optionC: "0",
                     optionD: "",
                     questionId: 465780990,
                     helpText: "5. Данный цикл напечатает 5 строк кода, с числами 8 - 6 - 4 - 2 - 0. * Ноль делится не только на 2, он делится на все степени двойки. В этом смысле, 0 является «наиболее чётным» числом из всех чисел."),
            ...
            Question(question: ["Если требования позволяют, предпочтительнее использовать инструкцию if или инструкцию guard?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 994020333,
                     helpText: "guard. Использование инструкции guard для каких-либо требований улучшает читабельность кода по сравнению с if. Он помогает вам написать код, который вам не нужно будет помещать в блок else и позволит вам держать код, который обрабатывает нарушение требований рядом с самими требованиями."),
            ...
            Question(question: ["Получим ли мы сообщение в консоль?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 125193675,
                     helpText: "Нет. Оба условия спрашивают именно про первую переменную age1, и так как она = 18, то оба условия не выполняются, и внутрь мы не попадаем. Кстати, перевод фразы внутри print звучит так: \"Был ли ты внимателен?\"."),

    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Сколько разновидностей цикла поддерживает Swift?",
                     ...
                     helpText: "Свифт поддерживает циклы: for-in, while и repeat-while."),
            ...
            Question(question: ["Что мы получим в консоль?"],
                     ...
                     helpText: "В консоль напечатается Yes, потому что в первой проверке у нас будет true."),
            ...
            Question(question: ["Получим ли мы Success в консоль?"],
                     ...
                     helpText: "Мы столкнемся с ошибкой компиляции: Binary operator '>=' cannot be applied to operands of type 'Int' and 'Double', поскольку мы пытаемся сравнить два числа разных типов. Нижнее подчеркивание может ставится в любом месте вашего числа, оно используется исключительно для красоты."),
            ...
            Question(question: ["Напечатается ли наша строка в консоль хотя бы раз?"],
                     ...
                     helpText: "Когда наша переменная counter будет равна 6 - мы зайдем внутрь цикла while, прибавим 2, и получим проходное значение для условия if counter == 8, распечаем строку \"Удачи в изучении!\" и в следующей итерации уже не попадем на новый круг, потому что с 8 не пройдем проверку while counter < 8."),
            ...
            Question(question: ["Получим ли мы строки в консоль? Если да, то сколько?"],
                     ...
                     helpText: "Мы выполним данный цикл repeat всего один обязательный раз, который заложен в реализацию цикла repeat - while. Внутри него мы один раз запустим цикл for-in, состоящий из 4 итераций, которые напечатают нам 4 строчки Hello!"),
            ...
            Question(question: ["Сколько строчек кода мы увидим в консоли после запуска?"],
                     ...
                     helpText: "Данный цикл выполнит ровно четыре итерации, 0 - 1 - 2 - 3, то есть в консоль мы получим четыре строки \"Line of code\"."),
            ...
            Question(question: ["Что мы получим, запустив данный код?"],
                     ...
                     helpText: "Мы получим ошибку компиляции (Binary operator '>=' cannot be applied to operands of type 'String' and 'Int'), поскольку мы не можем корректно сравнивать значения типа String и Int между собой."),
            ...
            Question(question: [
                ...
                "Можем ли мы употреблять привязку значения внутри составного кейса в switch?"
                     ...
                     helpText: """
                     Составные кейсы в инструкции switch так же могут включать в себя привязку значения. Все шаблоны составных кейсов должны включать в себя тот же самый набор значений и каждая связка должна быть одного и того же типа из всех шаблонов составного кейса.
            ...
            Question(question: ["Сколько строк кода мы получим в консоль?"],
                     ...
                     helpText: "Данный цикл выполнит ровно три итерации, 1 - 2 - 3, то есть в консоль мы получим три строки \"Line of code\"."),
            ...
            Question(question: ["Что мы получим в консоль?"],
                     ...
                     helpText: "Так как наша переменная = false, мы не пройдем первую проверку и попадем в блок else, после чего в консоль выведется Off."),
            ...
            Question(question: ["Какой из циклов мы остановим через выполнение break generalLoop?"],
                     ...
                     helpText: "Swift имеет встроенное ключевое слово break, которое позволяет выходить из цикла, в котором вы находитесь, но что произойдет, если вы находитесь в двух или более циклах и хотите прервать их все? Для этого вы можете проименовать родительский цикл, и обратиться по этому имени, чтобы остановить его (что повлечет за собой остановку всех вложенных)."),
            ...
            Question(question: ["Что мы получим в консоль?"],
                     ...
                     helpText: "Мы получим Other city в консоль. Поскольку мы не прошли первую проверку (получили false) и попали в блок else."),
            ...
            Question(question: ["Сколько строк кода мы получим в консоль?"],
                     ...
                     helpText: "После проверки if i < 4 мы сможем распечатать в консоль только две строки, когда i будет равна 2 и 3."),
            ...
            Question(question: ["Сколько строк кода мы получим в консоль?"],
                     ...
                     helpText: "Это задание на внимательность, мы получим 3 строки. Внутри самого цикла мы получим 2 строчки \"We got our number\", но перед циклом мы выполним print(\"We start looping\"), в которой распечатаем еще одну строку."),
            ...
            Question(question: ["Сколько строк кода напечатает данный цикл?"],
                     ...
                     helpText: "Данный цикл напечатает 5 строк кода, с числами 8 - 6 - 4 - 2 - 0. * Ноль делится не только на 2, он делится на все степени двойки. В этом смысле, 0 является «наиболее чётным» числом из всех чисел."),
            ...
            Question(question: ["Можем ли мы выполнить подобную итерацию по кортежу целых чисел?"],
                     ...
                     helpText: "Мы не сможем выполнить итерацию по кортежу, кортеж не поддерживает протокол Sequence, и мы получим следующую ошибку компиляции: For-in loop requires '(Int, Int, Int)' to conform to 'Sequence'."),
            ...
            Question(question: ["Получим ли мы сообщение в консоль?"],
                     ...
                     helpText: "Оба условия спрашивают именно про первую переменную age1, и так как она = 18, то оба условия не выполняются, и внутрь мы не попадаем. Кстати, перевод фразы внутри print звучит так: \"Был ли ты внимателен?\"."),
            ...
            Question(question: ["Сколько строк кода мы получим в консоль?"],
                     ...
                     helpText: "В данном случае мы столкнемся с ошибкой компиляции, поскольку num является константой, и ее нельзя модифицировать (Left side of mutating operator isn't mutable: 'num' is a 'let' constant)."),
        ]
    }
}

    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["В каком варианте указана валидная инициализация коллекции?"],
                     ...
                     optionD: "",
                     questionId: 607365857,
                     helpText: "В данном случае правильной является инициализация коллекции во втором варианте, потому что в первом мы указываем тип множества в неправильных скобках, вместо квадратных там должны быть угловые. Корректным вариантом была бы версия var friends = Set<String>()."),
            ...
            Question(question: ["В каком варианте указана валидная инициализация коллекции?"],
                     ...
                     optionD: "",
                     questionId: 812499369,
                     helpText: "Корректная инициализация коллекции происходит в первом варианте, во втором - мы не указали тип множества. Второй вариант был бы корректен, например, в таком случае: var badges = Set<Int>()."),
        ]
    }
}

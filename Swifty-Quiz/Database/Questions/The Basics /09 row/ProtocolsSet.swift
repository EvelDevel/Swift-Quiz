...
class ProtocolsSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Можем ли мы расширять протокол, чтобы реализовать дополнитульную функциональность?",
            ...
            Question(question: ["Где помещяется имя протокола при определении пользовательского типа?",
            ...
            Question(question: ["Как маркируются свойства внутри протокола, значения которых вы можете получить или изменить?",
                                "Свойства, значения которых вы можете получить или изменить, в протоколах миркируются так"],
                     image: "",
                     optionA: "{ get set }",
                     optionB: "{ set }",
                     optionC: "{ get }",
            ...
            Question(question: ["Как маркируются свойства внутри протокола, значения которых вы можете только получить?",
                                "Свойства, значения которых вы можете только получить, в протоколах миркируются так"],
                     image: "",
                     optionA: "{ get }",
                     optionB: "{ get set }",
                     optionC: "{ set }",
            ...
            Question(question: ["Является ли протокол типом?",
                                "Протоколы сами по себе не несут новой функциональности, тем неменее являются ли они полноправными типами?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["Может ли протокол наследовать множество других протоколов?",
                                ...
                                "Может ли протокол добавлять требования поверх тех требований протоколов, которые он наследует?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",

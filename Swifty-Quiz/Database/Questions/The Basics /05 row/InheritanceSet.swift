...
class InheritanceSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Может ли класс добавлять наблюдателей свойств к наследованным свойствам?",
                                "Можете ли вы добавить наблюдателей свойств к наследованным свойствам?",
                                "Мы можем добавить наблюдателей свойств к наследованным свойствам, так ли это?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
            ...
            Question(question: ["Какое ключевое слово используется для переопределения?",
                                ...
                                "Чтобы переопределять методи и свойства суперкласса, используется это ключевое слово"],
                     image: "",
                     optionA: "override",
                     optionB: "overwrite",
                     optionC: "overdrive",
            ...
            Question(question: ["Если вы предоставляете сеттер как часть переопределения свойства, должны ли вы предоставить и геттер?",
                                "При преоставлении сеттера, как части переопределения свойства, должны ли мы предоставлять и геттер?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",

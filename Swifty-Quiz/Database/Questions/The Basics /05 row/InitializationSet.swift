...
class InitializationSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Как делигируют назначенные инициализаторы?",
                                "Назначенные инициализаторы делигируют таким образом"],
                     image: "",
            ...
            Question(question: ["Сколько вспомогательных инициализаторов имеет суперкласс?",
                                "Сколько назначенных инициализаторо имеет подкласс?"],
            ...
            Question(question: ["Если назначенный инициализатор не делигирует суперклассу инициализатор до присваивания значений унаследованным свойствам, что произойдет со значениями, которые он присвоил?"],
                     image: "",
            ...
            Question(question: ["Если вспомогательный инициализатор не делегировал другому инициализатору до того, как были присвоены значения любым свойствам, что произойдет о значениями свойств?"],
                     image: "",
            ...
            Question(question: ["Могут ли подклассы менять унаследованные переменные свойства в процессе инициализации?",
                                "В процесе инициализации подклассы могут менять унаследованные переменные свойства, так ли это?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
            ...
            Question(question: ["Какой инициализатор мы будем использовать, когда нам нужно, чтобы каждый подкласс этого класса был обяхан реализовать его?"],
                     image: "",
                     optionA: "Требуемый",
                     optionB: "Назначенный",
                     optionC: "Вспомогательный",

    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["С какой буквы должно начинаться имя переменной в Swift?",
                                "Мы должны написать имя переменной или константы с этой буквы",
                     ...
                     correctAnswer: 1,
                     questionId: 1,
                     helpText: "Хорошей практикой является использование названий в CamelCase. То есть названия начинаются со строчной буквы. Если название состоит из нескольких слов, то только первое начинается со строчной буквы."),
            ...
            Question(question: ["Переменная, значение которой можно установить только один раз и нельзя изменить в дальнейшем",
                                "Значение этой переменной можно установить только один раз, без возможности менять его в дальнейшем" ],
                     image: "",
                     optionA: "Лямбда",
                     optionB: "Постоянная",
                     optionC: "Константа",
            ...
            Question(question: ["Что мы получим, при попытке запустить этот код?"],
                     image: "TheBasics37",
                     optionA: "Переменной присваивается число",

    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Должны ли элементы внутри кортежа быть одного и того же типа?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 832713231,
                     helpText: "Кортежи группируют несколько значений в одно составное значение. Значения внутри кортежа могут быть любого типа, то есть, нет необходимости, чтобы они были одного и того же типа."),
            ...
            Question(question: ["Могут ли элементы в кортеже распологаться в произвольном порядке?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 198307475,
                     helpText: "Вы можете создать кортеж с любой расстановкой типов, и они могут содержать сколько угодно нужных вам типов. Ничто вам не мешает иметь кортеж типа (Int, Int, Int), или типа (String, Bool), или же с любой другой расстановкой типов по вашему желанию."),
            ...
            Question(question: ["Если мы добавили в кортеж сначала целое число, а потом строковое значение, какой тип кортежа у нас получится?"],
                     ...
                     optionD: "",
                     questionId: 790787982,
                     helpText: "Если мы группируем вместе два отдельных значения Int и String, это может быть описано как \"кортеж типа (Int, String)\"."),
            ...
            Question(question: ["Как мы можем \"игнорировать\" некоторые элементы массива?"],
                     ...
                     optionD: "",
                     questionId: 767061987,
                     helpText: "Если вам нужны только некоторые из значений кортежа, вы можете игнорировать части кортежа во время разложения с помощью символа подчеркивания (_)"),
            ...
            Question(question: ["Мы можем обращаться к элементам кортежа, как?"],
                     ...
                     optionC: "По ключу",
                     optionD: "",
                     questionId: 670017582,
                     helpText: "Можно получать доступ к отдельным частям кортежа, используя числовые индексы, начинающиеся с нуля."),
            ...
            Question(question: ["Можете ли вы обратиться к элементу кортежа по имени, которое присвоили ранее, при объявлении?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 955455333,
                     helpText: "Когда вы присвоили имя элементу кортежа, вы можете обращаться к нему по имени."),

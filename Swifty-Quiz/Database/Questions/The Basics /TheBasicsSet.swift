    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Минимальная функциональная единица, выполняющая определенную операцию",
                     ...
                     optionC: "Выражение",
                     optionD: "",
                     questionId: 120674603,
                     helpText: "Оператор — это минимальная независимая функциональная единица (символ, слово или группа слов), выполняющая определенную операцию. Это одно из основных понятий, с которым вам предстоит встречаться в ходе обучения разработке на Swift. Благодаря операторам мы можем работать с данными. В будущем, в процессе создания приложений, вы будете регулярно применять различные операторы, а также при необходимости создавать собственные."),
            ...
            Question(question: ["Обязана ли константа или переменная иметь имя?" ],
                     ...
                     optionD: "",
                     questionId: 703851560,
                     helpText: "Любое хранилище, неважно, какого вида обязано иметь имя, по которому можно проинициализировать новое или получить записанное ранее значение."),
            ...
            Question(question: ["Множество возможных значений и операций с этими значениями, которые мы присваиваем объекту?"],
                     ...
                     optionC: "Аргументы",
                     optionD: "",
                     questionId: 597074158,
                     helpText: "Тип данных — это множество возможных значений и операций с этими значениями. Тип данных определяет не только характеристики объекта, но и то, что с ними можно делать. В Swift типы данных определяют: значения, которые хранятся в параметрах: целые числа, дробные числа, строки и отдельные символы, логические значения или другой вид информации; а так же операции, которые с этими значениями можно произвести: числа складывать или вычитать, строки объединять между собой и т. д."),
            ...
            Question(question: ["Каждая переменная или константа имеет тип данных. Так ли это?"],
                     ...
                     optionD: "",
                     questionId: 695176009,
                     helpText: "Любое хранилище, неважно, какого вида, имеет тип данных, определяющий множество значений, которые могут храниться в этом хранилище (целые числа, строки и т. д.). Явное указание типа при этом необязательно, если вы не указали тип, он будет присвоен автоматически из контекста (из проинициализированного значения)."),
            ...
            Question(question: ["Можете ли вы создать переменную с именем, уже занятым другой переменной (в одной \"области видимости\")?",
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 851417725,
                     helpText: "Имена должны быть уникальными. Нельзя создавать переменную или константу с именем, уже занятым другой переменной или константой. Единственным исключением является ситуация, когда эти переменные и константы находятся в разных областях видимости. Например: вы можете назвать локальную переменную (внутри функции) так же, как называли глобальную переменную. Пока области их видимости не пересекаются, конфликта не будет."),
            ...
            Question(question: ["Разрешит ли Swift инициализировать две переменные таким образом?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 495770020,
                     helpText: "При объявлении нескольких переменных или констант вы можете использовать один оператор — var или let и через запятую попарно указать их имена и инициализируемые значения."),
            ...
            Question(question: ["Если мы точно уверены, что значение переменной меняться не будет, что нам нужно использовать?",
                     ...
                     optionC: "Литерал",
                     optionD: "Структуру",
                     questionId: 139322793,
                     helpText: "Кроме переменных для хранения данных в программе могут использоваться константы. Константы подобны переменным, они также хранят некоторое значение, за тем исключением, что определяются с помощью ключевого слова let и мы не можем после их инициализации изменить их значение. Если хранимое значение в вашем коде не будет меняться, всегда объявляйте его как константу. Используйте переменные только для хранения значений, которые должны будут меняться."),
            ...
            Question(question: ["Что не могут содержать имена констант и переменных?",
                     ...
                     optionD: "",
                     questionId: 602301579,
                     helpText: "Имена констант и переменных не могут содержать пробелы, математические символы, стрелки, приватные (или невалидные) кодовые точки Unicode, а так жетакже символы отрисовки линий или прямоугольников. Так имена не могут начинаться с цифр, хотя цифры могут быть включены в имя в любом другом месте."),
            ...
            Question(question: ["Скомпилируется ли данный код?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 275158535,
                     helpText: "Данный код не будет компилироваться, поскольку мы обращаемся к несуществующей переменной greetings. Получим ошибку \"Cannot find greetings in scope\" - что означает, что xcode не может найти данную переменную в этой области видимости."),
            ...
            Question(question: ["В каком варианте указана валидная инициализация коллекции?"],
                     ...
                     optionD: "",
                     questionId: 918072994,
                     helpText: "Правильная инициализация указана в варианте №1, во втором - при указании типа \"Массив\" мы не уточняем в угловых скобках, какой тип будет использоваться. Правильной инициализацией считалась бы запись var array = Array<String>()."),
            ...
            Question(question: ["Ключевое слово для подключения модуля к контроллеру",
                     ...
                     optionC: "func",
                     optionD: "invite",
                     questionId: 757078826,
                     helpText: "Правильный ответ: import."),
            
            Question(question: ["Можем ли мы использовать постфиксные операторы инкремента и декремента в Swift?"],
                     image: "",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "Иногда",
                     optionD: "",
                     questionId: 603921109,
                     helpText: "В Swift отсутствуют довольно популярные в других языках операторы инкремента (++) и декремента (--), увеличивающие и уменьшающие значение на единицу соответственно."),
            ...
            Question(question: ["В каком из этих вариантов объявляется новая переменная?"],
                     ...
                     optionC: "Ни в каком",
                     optionD: "",
                     questionId: 326135577,
                     helpText: "Новая переменная объявляется во втором варианте, для создания новой - мы всегда используем ключевое слово var. Если ключевое слово не используется - то мы изменяем уже существующую переменную (если она есть)."),
            ...
            Question(question: ["Специальный механизм, позволяющий преобразовывать одни типы данных в другие?"],
                     ...
                     optionC: "Подчинение",
                     optionD: "",
                     questionId: 612079213,
                     helpText: "Специальный механизм, позволяющий преобразовывать одни типы данных в другие, называется \"приведением\" (от слова «привести»), выполнен он в виде множества глобальных функций. Int(_:) — преобразовывает переданное значение к типу данных Int. Double(_:) — преобразовывает переданное значение к типу данных Double. Float(_:) — преобразовывает переданное значение к типу данных Float. Для применения данных функций в скобках после названия требуется передать преобразуемый элемент (переменную, константу, число)."),
            ...
            Question(question: ["Набор элементов, выстроенных в очередь, в котором есть возможность осуществлять последовательный (поочередный) доступ к ним"],
                     ...
                     optionC: "Класс",
                     optionD: "Константа",
                     questionId: 339661765,
                     helpText: "Последовательность (Sequence) — набор элементов, выстроенных в очередь, в котором есть возможность осуществлять последовательный (поочередный) доступ к ним. При этом не предусмотрен механизм, позволяющий обратиться к какому-либо определенному элементу напрямую. Вы можете лишь последовательно перебирать элементы. Sequence — это протокол, определяющий требования, при которых значение типа данных может называться последовательностью. Протокол Sequence требует, чтобы тип обеспечивал хранение множества однотипных значений и организовывал доступ к ним с помощью последовательного перебора."),
            ...
            Question(question: ["Выберите корректное обозначение типа (аннотацию) для переменной, чтобы обозначить, что переменная может хранить String:"],
                     ...
                     optionD: "",
                     questionId: 576669906,
                     helpText: "Вы можете добавить обозначение типа, когда объявляете константу или переменную, чтобы иметь четкое представление о типах значений, которые могут хранить константы или переменные. Написать обозначение типа, можно поместив двоеточие после имени константы или переменной, затем пробел, за которым следует название используемого типа. Наш пример добавляет обозначение типа для переменной с именем welcomeMessage, чтобы обозначить, что переменная может хранить String:"),
            ...
            Question(question: ["В каком из вариантов объявляется новая константа?"],
                     ...
                     optionC: "Ни в каком",
                     optionD: "",
                     questionId: 595374301,
                     helpText: "Правильный ответ: В первом. Объявление новой константы всегда происходит с использованием ключевого слова let. Все последующие обращения к этой константе происходит уже без ключевого слова. Как вы можете помнить или знать - изменять константу нельзя, поэтому этот случай мы не рассматриваем."),
            ...
            Question(question: ["var red, green, blue: Double. Можем ли подобным образом создавать несколько переменных с явным объявлением одного и того же типа для всех?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 672345681,
                     helpText: "Вы можете создать несколько переменных одного типа в одной строке, разделенной запятыми, с одной аннотацией типа после последнего имени переменной. Редко когда вам понадобится обозначать тип на практике. Когда вы даете начальное значение константе или переменной на момент объявления, Swift всегда может вывести тип, который будет использовать в константе или переменной."),

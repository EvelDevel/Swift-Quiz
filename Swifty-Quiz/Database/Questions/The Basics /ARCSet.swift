		...
		return [
			...
			Question(question: [
                ...
                "Свифт создает эту ссылку каждый раз, когда вы присваиваете экземпляр свойству, переменной, или константе"
					 ...
					 optionD: "",
					 questionId: 806667943,
                     helpText: """
                     Сильная ссылка. Каждый раз как вы присваиваете экземпляр свойству, константе или переменной создается strong reference (сильная ссылка) с этим экземпляром. Такая связь называется “сильной”, так как она крепко держится за этот экземпляр и не позволяет ему освободится до тех пор, пока остаются сильные связи.
                     """),
			...
			Question(question: [
                ...
                "Когда у нас сильные связи у экземпляров (друг с другом), и экземпляры никогда не будут иметь нулевое количество сильных ссылок, как это называется?"
					 ...
					 questionId: 376936202,
                     helpText: """
                     Цикл сильных ссылок. Возможно написать код, в котором экземпляр класса никогда не будет иметь нулевое число сильных ссылок. Это может случиться, если экземпляры классов имеют сильные связи друг с другом, что не позволяет им освободиться. Это известно как цикл сильных ссылок.
                     """),
			...
			Question(question: [
                ...
                "Ключевое слово, обозначающее слабую ссылку"
					 ...
					 optionC: "unowned",
					 optionD: "week",
					 questionId: 389235963,
                     helpText: """
                     weak. Слабые и бесхозные ссылки позволяют одному экземпляру в цикле ссылок ссылаться на другой экземпляр без сильного прикрепления. Экземпляры могут ссылаться друг на друга без создания цикла сильных связей.
                     """),
			
			Question(question: [
                "Что может вызвать цикл сильных ссылок?",
                "Цикл сильных ссылок может вызывать это"
					 ...
					 questionId: 607503936,
                     helpText: """
                     Утечка памяти. Цикл сильных ссылок предотвращает освобождение экземпляров, что вызывает утечку памяти в вашем приложении.
                     """),
			...
			Question(question: [
                ...
                "Какие ссылки помогают экземплярам ссылаться друг на друга без создания цикла сильных связей?"
					 ...
					 questionId: 313219102,
                     helpText: """
                     Слабые и бесхозные. Эти ссылки позволяют одному экземпляру в цикле ссылок ссылаться на другой экземпляр без сильного прикрепления. Экземпляры могут ссылаться друг на друга без создания цикла сильных связей.
                     """),
			...
			Question(question: [
                "Какую ссылку предпочтительнее использовать, когда другой экземпляр имеет более короткое время жизни (то есть когда другой экземпляр может быть освобожден первым)?"
					 ...
					 image: "",
					 optionA: "Слабую ссылку",
					 optionB: "Сильную ссылку",
					 optionC: "Бесхозную ссылку",
					 optionD: "",
					 questionId: 466812939,
                     helpText: """
                     Слабая ссылка. Используйте слабую ссылку, если другой экземпляр имеет более короткое время жизни, то есть когда другой экземпляр может быть освобожден первым.
                     """),
			...
			Question(question: [
                "Какую ссылку предпочтительнее использовать, когда другой экземпляр имеет одинаковое время жизни или более длительный срок службы?"
					 ...
					 image: "",
					 optionA: "Бесхозную ссылку",
					 optionB: "Сильную ссылку",
					 optionC: "Слабую ссылку",
					 optionD: "",
					 questionId: 897889847,
                     helpText: """
                     Бесхозная ссылка. Используйте бесхозные ссылки, если другой экземпляр имеет одинаковое время жизни или более длительный срок службы.
                     """),
			
			Question(question: [
                "Как слабые ссылки позволяют избежать ситуации, когда ссылка становится частью цикла сильных ссылок?",
                ...
                "Как мы избегаем циклов сильных ссылок, используя слабые ссылки?"
					 ...
					 optionD: "",
					 questionId: 328680699,
                     helpText: """
                     ARC не берет их во внимание. Слабые ссылки не удерживаются за экземпляр, на который они указывают, так что ARC не берет их во внимание, когда считает ссылки экземпляра.
                     
                     Такой подход позволяет избежать ситуации, когда ссылка становится частью цикла сильных ссылок. Вы указываете слабую ссылку ключевым словом weak перед объявлением имени свойства или переменной.
                     """),
			
			Question(question: [
                "Мы должны объявлять слабые ссылки как переменные или константы?",
                "Мы объявляем слабые ссылки в коде как константы, или как переменные?"
					 ...
					 questionId: 284433096,
                     helpText: """
                     Переменные. Так как слабая ссылка не сильно держит экземпляр, то этот экземпляр может быть освобожден, пока слабая ссылка все еще ссылается на него.
                     
                     Таким образом ARC автоматически присваивает слабой ссылке nil, когда экземпляр, на который она указывает, освобождается. И поскольку слабые ссылки должны позволять изменять их значение до нуля во время выполнения, они всегда объявляются как переменные, а не как константы опционального типа.
                     """),
			
			Question(question: [
                "Можем ли мы проверять наличие значения в слабой ссылке?",
                ...
                "Мы можем проверять существование значения в слабой ссылке точно так же, как и с любыми другими опциональными значениями. Это так?"
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 193631869,
                     helpText: """
                     Да. Вы можете проверить существование значения в слабой ссылке точно так же как и с любыми другими опциональными значениями, и вы никогда не будете иметь ссылку с недопустимым значением, например, указывающую на несуществующий экземпляр.
                     """),
			
			Question(question: [
                "Вызываются ли наблюдатели свойств, когда ARC устанавливает слабую ссылку на nil?",
                "Когда ARC устанавливает слабую ссылку на nil, вызываются ли наблюдатели свойств?"
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 857772304,
                     helpText: """
                     Нет. Когда ARC устанавливает слабую ссылку на nil, наблюдатели свойств не вызываются.
                     """),
			
			Question(question: [
                "Чем отличается бесхозная ссылка от слабой?",
                ...
                "Бесхозная ссылка отличается от слабой ссылки именно этим"
					 ...
					 optionD: "",
					 questionId: 946209029,
                     helpText: """
                     Всегда имеет значение. Как и слабые ссылки, бесхозные ссылки так же не имеют сильной связи с экземпляром, на который они указывают. В отличии от слабых ссылок, бесхозные ссылки всегда имеют значение. Из-за этого бесхозные ссылки имеют неопциональный тип.
                     """),
			
			Question(question: [
                "Каким ключевым словом обозначается бесхозная ссылка?",
                ...
                "Бесхозная ссылка обозначается этим ключевым словом"
					 ...
					 optionC: "strong",
					 optionD: "static",
					 questionId: 358095269,
                     helpText: """
                     unowned. Вы указываете на то, что ссылка бесхозная ключевым словом unowned, поставленным перед объявлением свойства или переменной.
                     """),
			
			Question(question: [
                "Является ли бесхозная ссылка опциональной?",
                "Бесхозная ссылка является опциональной, так ли это?"
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 692696110,
                     helpText: """
                     Нет. Так как бесхозная ссылка не является опциональной, то вам не нужно и разворачивать ее каждый раз, когда вы собираетесь ее использовать. Вы можете обратиться к бесхозной ссылке напрямую.
                     """),
			
			Question(question: [
                "Может ли ARC установить значение бесхозной ссылки на nil?",
                "ARC может установить значение бесхозной ссылки на nil, так ли это?"
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 539304566,
                     helpText: """
                     Нет. ARC не может установить значение бесхозной ссылки на nil, когда экземпляр, на который она ссылается, освобожден, так как переменные не опционального типа не могут иметь значения nil.
                     """),
			
			Question(question: [
                "Если вы попытаетесь получить доступ к бесхозной ссылке после того, как экземпляр, на который она ссылается освобожден, произойдет это",
                "Что произойдет, если вы вы попытаетесь получить доступ к бесхозной ссылке после того, как экземпляр, на который она ссылается освобожден?"
					 ...
					 optionC: "Ничего",
					 optionD: "Получим nil",
					 questionId: 578390717,
                     helpText: """
                     Runtime error. Используйте бесхозные ссылки только в том случае, если вы абсолютно уверены в том, что ссылка всегда будет указывать на экземпляр. Если вы попытаетесь получить доступ к бесхозной ссылке после того, как экземпляр, на который она ссылается освобожден, то выскочит runtime ошибка.
                     """),
			...
			Question(question: [
                ...
                "Сильные ссылки так же могут образовываться, когда вы присваиваете замыкание свойству экземпляра класса, и тело замыкания захватывает экземпляр. Так ли это?"
                     ...
                     В обоих случаях эти доступы и вызывают тот самый “захват” self, при этом создавая цикл сильных ссылок. Этот цикл возникает из-за того, что замыкания, как и классы, являются ссылочными типами. Когда вы присваиваете замыкание свойству, вы присваиваете ссылку на это замыкание.
                     """),
			...
			Question(question: [
                ...
                "Вы можете сделать это, чтобы не допустить цикла сильных ссылок между замыканием и экземпляром класса"
					 ...
					 optionD: "",
					 questionId: 239563627,
                     helpText: """
                     Определение списка захвата. Заменить цикл сильных ссылок между замыканием и экземпляром класса можно путем определения списка захвата в качестве части определения замыкания. Список захвата определяет правила, которые нужно использовать при захвате одного или более ссылочного типа в теле замыкания.
                     """),
			...
			Question(question: [
                "Если захваченная ссылка никогда не будет nil, нам стоит выбрать бесхозную или слабую ссылку?",
                "Мы выбираем бесхозную или слабую ссылку, если захваченная ссылка никогда не будет nil?"
					 ...
					 optionD: "",
					 questionId: 184898516,
                     helpText: """
                     Как бесхозная. Если захваченная ссылка никогда не будет nil, то она должна быть всегда захвачена как unowned ссылка, а не weak ссылка.
                     """)
		]
	}
}

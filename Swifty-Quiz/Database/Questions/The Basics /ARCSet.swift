...
class ARCSet {
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: [
                "Какое ключевое слово обозначает weak ссылку?",
                "weak ссылку обозначает это ключевое слово",
                "Ключевое слово, обозначающее weak ссылку"
            ],
					 image: "",
					 optionA: "weak",
					 optionB: "strong",
			...
			Question(question: [
                "Какую ссылку предпочтительнее использовать, когда другой экземпляр имеет более короткое время жизни (то есть когда другой экземпляр может быть освобожден первым)?"
					 ...
					 image: "",
					 optionA: "weak ссылку",
					 optionB: "strong ссылку",
					 optionC: "unowned ссылку",
					 optionD: "",
					 questionId: 466812939,
                     helpText: """
                     weak ссылка. Используйте weak ссылку, если другой экземпляр имеет более короткое время жизни, то есть когда другой экземпляр может быть освобожден первым.
                     """),
			...
			Question(question: [
                ...
                "Как мы избегаем циклов сильных ссылок, используя weak ссылки?"
                     ...
                     Такой подход позволяет избежать ситуации, когда ссылка становится частью цикла сильных ссылок. Вы указываете weak ссылку ключевым словом weak перед объявлением имени свойства или переменной.
                     """),
			...
			Question(question: [
                "Вызываются ли наблюдатели свойств, когда ARC устанавливает weak ссылку на nil?",
                "Когда ARC устанавливает weak ссылку на nil, вызываются ли наблюдатели свойств?"
            ],
					 image: "",
					 optionA: "Нет",
					 optionB: "Да",
                     ...
                     helpText: """
                     Нет. Когда ARC устанавливает weak ссылку на nil, наблюдатели свойств не вызываются.
                     """),
			...
			Question(question: [
                "Если захваченная ссылка никогда не будет nil, нам стоит выбрать unowned или weak ссылку?",
                "Мы выбираем unowned или weak ссылку, если захваченная ссылка никогда не будет nil?"
            ],
					 image: "",
					 optionA: "Как unowned",
					 optionB: "Как weak",
                     ...
                     helpText: """
                     Как unowned. Если захваченная ссылка никогда не будет nil, то она должна быть всегда захвачена как unowned ссылка, а не weak ссылка.
                     """)
		]
	}
}

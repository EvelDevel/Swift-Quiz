		...
		return [
            ...
            Question(question: [
                "Какое значение мы получим в консоль?"
                     ...
                     optionC: "6",
                     optionD: "2",
                     questionId: 690100590,
                     helpText: """
                     11. Замыкающие выражения обладают способностью сохранять начальные значения переданных в них переменных. Замыкающее выражение, на которое указывает константа сlosure, складывает значения переменных a и b. С изменением значений переменных также меняется результат замыкания.
                     """),
            ...
            Question(question: [
                "Какое значение мы получим в консоль?"
                     ...
                     Однако мы можем зафиксировать начальные значения переменных передав их в квадратные скобки: [a, b], мы тем самым фиксируем их начальные значения. И даже если значения этих переменных в какой-то момент изменятся, замыкание будет оперировать прежними значениями.
                     """),
		]
	}
}

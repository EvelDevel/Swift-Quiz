		...
		return [
			...
			Question(question: [
                ...
                "На этом этапе создания пользовательского типа вы должны явно указать уровень его доступа"
                     ...
                     helpText: """
                     На этапе определения типа. Если вы хотите указать явно уровень доступа для пользовательского типа, то делайте это на этапе определения типа. Новый тип может быть использован там, где позволяет его уровень доступа.
                     """),

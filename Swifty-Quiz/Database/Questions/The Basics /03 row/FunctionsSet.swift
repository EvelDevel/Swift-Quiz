...
class FunctionsSet {
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["При использовании второго входящего параметра в теле функции как мы будем к нему обращаться?",
                                "Как вы можете обратиться ко второму входящему параметру в теле функции?"],
                     image: "Functions19",
                     optionA: "second",
                     optionB: "and",
                     optionC: "and second",

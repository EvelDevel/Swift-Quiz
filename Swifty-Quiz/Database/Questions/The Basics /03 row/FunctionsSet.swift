    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Могут ли функции изменять внешние переменные после выполнения?",
                                ...
                                "Возможно ли в языке Swift изменение внешних перменных после выполнения функции?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["Как вы можете обратиться ко второму входящему параметру в теле функции?"],
                     image: "Functions19",
                     optionA: "second",
                     optionB: "and",
                     optionC: "and second",
            ...
            Question(question: ["При вызове функции, как мы обратимся ко второму входящему параметру?",
                                "Как вы сможете обратиться ко второму входящему параметру при вызове функции?"],
                     image: "Functions19",
                     optionA: "and",
                     optionB: "second",
                     optionC: "and second",
                     ...
                     correctAnswer: 1,
                     questionId: 20,
                     helpText: "Правильный ответ: and. Каждый параметр функции имеет ярлык аргумента (указывается первым) и имя параметра (указывается вторым). При вызове функции используется именно ярлык аргумента. Использование ярлыков аргументов позволяет функции вызываться в более выразительной манере, в виде предложения, при этом все же предоставляя тело функции в более читаемом виде и с более понятыми намерениями."),
            ...
            Question(question: ["Можем ли мы опустить один или несколько параметров при вызове функции, если у них есть значение по умолчанию?",
                     ...
                     correctAnswer: 1,
                     questionId: 23,
                     helpText: "Если у параметра есть значение по умолчанию, то при вызове функции этот параметр можно опустить. Расположите параметры, у которых нет дефолтных значений в начале списка параметров функции до параметров с дефолтными значениями. Параметры, не имеющие значения по умолчанию, как правило, более важны для значения функции - их запись в первую очередь облегчает разпознавание функции уже вызванной ранее, независимо от того, опущены ли какие-то параметры по умолчанию."),
            ...
            Question(question: ["Если вы попытаетесь в теле функции изменить ее входящий параметр, что произойдет?",
                                "Что получитя, если попытаться изменить входящий параметр функции в ее теле?",
            ...
            Question(question: ["Можем ли мы использовать функциональные типы как типы входящих параметров другой функции?",
                                "Можете ли вы использовать функциональный тип как тип входящего параметра функции?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["Можем ли мы объявлять вложенные функции?",
                                "Можем ли мы создавать неглобальные, а вложенные функции?",
            ...
            Question(question: ["Каким образом мы можем получить доступ к вложенной функции?",
                                "Как мы можем получить доступ к неглобальной, вложенной функции?",
            ...
            Question(question: ["Если код скомпилируется, что выведется в консоль?",
            ...
            Question(question: ["Что выведется в консоль?"],
                     ...
                     correctAnswer: 1,
                     questionId: 38,
                     helpText: "Правильный ответ: \"hello, world!\". В консоль выведеся именно это, возвращаемое значение функции мы не выводим в консоль. Оно просто есть, но не используется при вызове."),
            ...
            Question(question: ["Если данный код сработает, что выведется в консоль?"],
                     image: "Functions40",
                     ...
                     correctAnswer: 1,
                     questionId: 40,
                     helpText: "Ничего не выведется в консоль, поскольку мы получим ошибку. Мы игнорируем ярлык аргумента у входящей функции first, если мы укажем название входяшего параметра - код не запустится. Ошибка: Extraneous argument label 'first:' in call."),
            ...
            Question(question: ["В каком порядке значения будут в консоли?",
                                "В консоль выведутся значения в таком порядке"],
                     image: "Functions43",
                     optionA: "107 и 3",
                     optionB: "3 и 107",
                     optionC: "107 и 107",

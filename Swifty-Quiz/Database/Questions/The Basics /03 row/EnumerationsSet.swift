    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Что мы получим в консоль?",
                                "Что выведется в консоль после запуска?"],
            ...
            Question(question: ["Если все извлекаемые ассоциативные значения перечисления будут константами, мы можем вынести let на позицию после casе и перед указанием имени самого кейса?",
                                ...
                                "Если все ассоциативные значения перечисления будут переменными или константами, можем ли мы для краткости вынести let или var вначало кейса switch, и поставить после case?"],
                     image: "",
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "",
            ...
            Question(question: ["Какое значение выведется в консоль?",

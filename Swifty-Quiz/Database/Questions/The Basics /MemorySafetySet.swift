		...
		return [
			...
			Question(question: [
                "Как можно решить конфликт доступа к сквозным параметрам функции?"
                     ...
                     helpText: """
                     Один из способов решения конфликта доступа к сквозным параметрам функции - сделать явную копию переменной, и передавать при вызове функции именно копию.
                     """),

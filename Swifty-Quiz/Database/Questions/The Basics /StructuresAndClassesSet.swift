    ...
    static func getQuestions() -> [Question] {
        return [
            Question(question: ["Какое значение будет у first.value после выполнения кода?"],
                     ...
                     optionD: "",
                     questionId: 396222947,
                     helpText: "Так как Example является структурой (тип значения / value type), то после того, как мы произвели действие var second = first, мы создали копию значения first, и любые изменения у second не будут затрагивать экземпляр first. Поэтому его value продолжает быть равным 1."),

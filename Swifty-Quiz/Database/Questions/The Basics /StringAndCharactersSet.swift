	...
	static func getQuestions() -> [Question] {
		return [
            ...
            Question(question: ["Корректно ли мы создаем многострочный строковый литерал?"],
                     ...
                     optionC: "",
                     optionD: "",
                     questionId: 487517181,
                     helpText: "В этом случае мы столкнемся с ошибкой, поскольку в многострочном строковом литерале мы обязаны переносить закрывающие кавычки на новую строку (Ошибка: Multi-line string literal closing delimiter must begin on a new line)."),
            ...
            Question(question: ["Какая переменная будет с числовым типом?"],
                     ...
                     optionD: "",
                     questionId: 534474043,
                     helpText: "Переменная speed будет иметь тип Int, а переменная age будет иметь тип String (на это указывают двойные кавычки, говорящие, что это значение является строковым литералом)."),
            ...
            Question(question: ["Выберите номера строк, в которых создаются переменные типа String"],
                     ...
                     optionC: "5",
                     optionD: "4 и 5",
                     questionId: 319466490,
                     helpText: "Переменные типа String создаются в пятой и шестой строке. Несмотря на то, что в пятой строке мы присваиваем строковый литерал только с одним символом, тип будет String, а не Character. Если вы хотите создать переменную типа Character, вам необходимо будет сделать это явным образом, объявив этот тип."),

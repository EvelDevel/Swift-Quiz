	...
	static func getQuestions() -> [Question] {
		return [
			...
			Question(question: ["Может ли метод экземпляра иметь имя аргумента и ярлык аргумента одновременно?",
					 ...
					 optionD: "",
					 questionId: 344707491,
					 helpText: "Параметры функций могут иметь и имя аргумента (для использования внутри функций), и ярлык аргумента (для использования при вызове функций). То же самое верно для имен параметров методов, потому как методы те же самые функции, но ассоциированные с определенным типом."),
			...
			Question(question: ["Если мы находимся не внутри функции или метода, обязаны ли мы употреблять self постоянно?",
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 801191006,
					 helpText: "На практике вам не нужно писать self очень часто. Если вы не пишите self, то Swift полагает, что вы ссылаетесь на свойство или метод текущего экземпляра каждый раз, когда вы используете известное имя свойства или метода внутри метода. Главное исключение из этого правила получается, когда имя параметра метода экземпляра совпадает с именем свойства экземпляра. В этой ситуации имя параметра имеет приоритет и появляется необходимость сослаться на свойство в более подходящей форме. Вы используете свойство self для того, чтобы увидеть различие между именем параметра и именем свойства."),
			...
			Question(question: ["Если имя параметра метода экземпляра совпадает с именем свойства экземпляра, должны ли мы писать self при обращении к свойству?",
					 ...
					 optionC: "",
					 optionD: "",
					 questionId: 246314518,
					 helpText: "Когда имя параметра метода экземпляра совпадает с именем свойства экземпляра, появляется необходимость сослаться на свойство в более подходящей форме. Вы используете свойство self для того, чтобы увидеть различие между именем параметра и именем свойства."),

    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["На какие экземпляры применяется ARC?",
                                ...
                                "Какие типы экземпляров управляются по средствам ARC?"],
                     image: "",
            ...
            Question(question: ["Какое ключевое слово обозначает слабую ссылку?",
                     ...
                     correctAnswer: 1,
                     questionId: 1706,
                     helpText: "Правильный ответ: weak. Слабые и безхозные ссылки позволяют одному экземпляру в цикле ссылок ссылаться на другой экземпляр без сильного прикрепления. Экземпляры могут ссылаться друг на друга без создания цикла сильных связей."),
            ...
            Question(question: ["Какие ссылки позволяют одному экземпляру в цикле ссылок ссылаться на другой экземпляр без сильного прикрепления?",
                     ...
                     image: "",
                     optionA: "Слабые и безхозные",
                     optionB: "Сильные и слабые",
                     optionC: "Средние и безхозные",
                     optionD: "Безхозные и сильные",
                     correctAnswer: 1,
                     questionId: 1708,
                     helpText: "Слабые и безхозные ссылки позволяют одному экземпляру в цикле ссылок ссылаться на другой экземпляр без сильного прикрепления. Экземпляры могут ссылаться друг на друга без создания цикла сильных связей."),
            ...
            Question(question: ["Почему слабые ссылки позволяют избежать ситуации, когда ссылка становится частью цикла сильных ссылок?",
                     ...
                     optionB: "Сразу деинициализируются",
            ...
            Question(question: ["Чем отличается безхозная ссылка от слабой?",
                                "Чем, кроме названия, безхозная ссылка отличается от слабой?",
                                "Безхозная ссылка отличается от слабой ссылки именно этим"],
                     image: "",
            ...
            Question(question: ["Каким ключевым словом обозначается безхозная ссылка?",
                                "Ключевое слово, которым обозначается безхозная ссылка",
                                "Безхозная ссылка обозначается этим ключевым словом"],
                     image: "",
                     optionA: "unowned",
                     optionB: "weak",
                     optionC: "strong",
            ...
            Question(question: ["Является ли безхозная ссылка опциональной?",
                                "Безхозная ссылка является опциональной, так ли это?"],
                     image: "",
                     optionA: "Нет",
                     optionB: "Да",
                     optionC: "",
            ...
            Question(question: ["Может ли ARC установить значение безхозной ссылки на nil?",
                                "ARC может установить значение безхозной ссылки на nil, так ли это?",
                                ""],
                     image: "",
                     optionA: "Нет",
                     optionB: "Да",
                     ...
                     correctAnswer: 1,
                     questionId: 1718,
                     helpText: "ARC не может установить значение безхозной ссылки на nil, когда экземпляр, на который она ссылается, освобожден, так как переменные неопционального типа не могут иметь значения nil."),
            
            Question(question: ["Если вы попытаетесь получить доступ к безхозной ссылке после того, как экземпляр, на который она ссылается освобожден, произойдет это",
                                "Что произойдет, если вы вы попытаетесь получить доступ к безхозной ссылке после того, как экземпляр, на который она ссылается освобожден?"],
                     image: "",
                     ...
                     correctAnswer: 1,
                     questionId: 1719,
                     helpText: "Используйте бесхозные ссылки только в том случае, если вы абсолютно уверены в том, что ссылка всегда будет указывать на экземпляр. Если вы попытаетесь получить доступ к безхозной ссылке после того, как экземпляр, на который она ссылается освобожден, то выскочит runtime ошибка."),
            ...
            Question(question: ["Если захваченная ссылка никогда не будет nil, нам стоит выбрать безхозную или слабую ссылку?",
                                "Мы выбираем безхозную или слабую ссылку, если захваченная ссылка никогда не будет nil?"],
                     image: "",
                     optionA: "Как безхозная",
                     optionB: "Как слабая",

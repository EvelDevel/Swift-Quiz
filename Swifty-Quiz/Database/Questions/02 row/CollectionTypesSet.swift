    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Как мы можем удалить один или несколько последних элементов массива, при этом вернуть оставшийся массив?",
                     ...
                     image: "",
                     optionA: "array.remove(_ :at:)",
                     optionB: "array.removeLast()",
                     optionC: "array.dropLast()",
                     optionD: "array.deleteLast()",
                     correctAnswer: 3,
                     questionId: 32,
                     helpText: "Если вы хотите удалить последний или несколько последних элементов из массива, вы можете использовать метод dropLast(), в скобках необхоимо указать количество элементов, которые вы хотите удалить. После реализации данного метода вам вернется оставшяяся последовательность."),
            ...
            Question(question: ["Каким образом можно выполнить самое просто итерирование массива?",
                                "Этим способом можно выполнить простое итерирование массива, возвращая только элементы",
                                "Как мы можем выполнить просто итерирование массива, чтобы возвращать только элементы?"],
                     image: "",
                     optionA: "цикл while",
                     optionB: "цикл for-in",
                     optionC: "enumerated()",
            ...
            Question(question: ["Каким образом мы можем итерировать массив, чтобы вернуть кортежи значений, содержащие индекс и значение, находящееся на этом индексе?",
                     ...
                     correctAnswer: 3,
                     questionId: 36,
                     helpText: "Если вам нужен целочисленный индекс каждого значения так же как и само значение, используйте вместо этого глобальную функцию enumerated() для итерации по массиву. Функция enumerated() возвращает кортеж для каждого элемента массива, собрав вместе индекс и значение для этого элемента. При этом вы можете разложить кортеж во временные константы или переменные в рамках итерации: for (index, value) in someArray.enumerated() { print(index, value) }"),
            ...
            Question(question: ["Если контекст дает информацию о типе, можем ли мы создать пустое множество при помощи литерала пустого массива?",
                     ...
                     optionA: "Да",
                     optionB: "Нет",
                     optionC: "Если множество уже пустое",
                     optionD: "Если множество имеет элементы",
                     correctAnswer: 1,
                     questionId: 43,
            ...
            Question(question: ["Можем ли мы инициализировать множество при помощи литерала массива?",
                     ...
                     optionB: "Да, let ints: Set<Int> = [1, 2]",
            ...
            Question(question: ["Какой метод используется для того, чтобы из всех значений двух входных множеств создать новое множество?",
                                "Создать новое множество из всех значений двух входных множеств можно с помощью этого метода",
                                "Каким методом можно создать новое множество из всех значений других двух множеств?"],
                     image: "Collections48",
                     optionA: "union(_:)",
            ...
            Question(question: ["Какой метод используется для того, чтобы из общих значений двух входных множеств создать новое множество?",
                                "Создать новое множество только из общих значений двух множеств можно с помощью этого метода",
                                "Каким методом можно создать новое множество из общих значений других двух множеств?"],
                     image: "Collections49",
                     optionA: "union(_:)",
                     optionB: "intersection(_:)",
                     optionC: "subtracting(_:)",
            ...
            Question(question: ["Какой метод используется, чтобы из значений, не принадлежащих указанному множеству, создать новое множество?",
                                "Создать новое множество только из значений, не принадлежащих указанному множеству, можно с помощью этого метода",
                                "Каким методом можно создать новое множество из значений, не принадлежащих указанному множеству?"],
                     image: "Collections50",
                     optionA: "union(_:)",
                     optionB: "intersection(_:)",
                     optionC: "subtracting(_:)",
            ...
            Question(question: ["Какой метод используется для создания нового множества из значений, которые не повторяются в двух входных множествах?",
                                "Создать новое множество только из значений, которые не повторяются в двух входных множествах, можно с помощью этого метода",
                                "Каким методом можно создать новое множество из значений, которые не повторяются в двух входных множествах?"],
                     image: "Collections51",
                     optionA: "union(_:)",
                     optionB: "intersection(_:)",
                     optionC: "subtracting(_:)",
            ...
            Question(question: ["Какое из этих множеств является надмножеством другого множества?",
                                ...
                                "На картинке только одно множество является надмножеством другого множества, какое?"],
                     image: "Collections52",
                     optionA: "a",
                     optionB: "b",
                     optionC: "c",
            ...
            Question(question: ["Какое из этих множеств является подмножеством другого множества?",
                                ...
                                "На картинке только одно множество является подмножеством другого множества, какое?"],
                     image: "Collections52",
                     optionA: "a",
                     optionB: "b",
                     optionC: "c",
            ...
            Question(question: ["Каким образом можно добавлять и изменять элементы словаря через синтаксис индексов?",
                                "Как через синтаксис индексом можно добавлять и изменять значения словаря?"],
                     image: "",

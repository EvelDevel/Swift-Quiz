    ...
    static func getQuestions() -> [Question] {
        return [
            ...
            Question(question: ["Как из значений, не принадлежащих указанному множеству, создать новое множество?",
                                "Создать множество из значений, не принадлежащих указанному множеству, можно таким методом",
            ...
            Question(question: ["Метод использующийся для создания нового множества из неповторяющихся значений двух входных множеств?"],
                     image: "Collections51",
                     optionA: "union(_:)",
                     optionB: "intersection(_:)",
                     optionC: "subtracting(_:)",

...
class QuestionManager {
	...
	static func getAllGuideQuestions() -> [Question] {
	...
	static func getAllPatternsQuestions() -> [Question] {
	...
	static func getAllQuestionsCounter() -> Int {
		if allQuestions.isEmpty {
			allQuestions.append(contentsOf: QuestionManager.getAllGuideQuestions())
			allQuestions.append(contentsOf: QuestionManager.getAllPatternsQuestions())
		}

...
extension SettingCell {
    ...
    @IBAction func informationAboutSettingPressed(_ sender: UIButton) {
        ...
        case 5:
            ...
            message = "Вы можете включить функцию сохранения незавершенной игры, если посреди игры вы случайно свайпните вниз, выйдете в настройки, или на выбор темы - ваш рекорд сохранится. Если вы не меняете настройки или тему, вы всегда можете продолжить игру с момента, где остановились. Не работает, если вы свернули приложение, а потом смахнули его (закрыли)."
        case 6:
            title = "Звуки"

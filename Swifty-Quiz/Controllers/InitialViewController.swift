...
// Баг: Можно нажимать сразу несколько ответов, если среди них есть правильный - засчитываются очки
// Баг: Если мы играем через "продолжить" и делаем "перезапуск" - игра не сохраняется
// Из-за того, что теперь в синглтон сохраняется исходный массив есть глюк с продолжением игры с шафленными вопросами

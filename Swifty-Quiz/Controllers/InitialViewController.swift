...
// MARK: TODO
/// Сделать возможность "продолжить незавершенную игру" (доп. кнопка)
/// - При выходе появляется кнопка "продолжить"
/// - Рекорд сохраняется, если стоит такая настройка, и потом сохраняется рекорд полной игры
/// - При продолжении игры - если были изменены настройки - они обновляются и продолжение идет с новыми
/// 
/// Сделать настройки через таблицу (для возможности расширения)
/// Заменить настройку звука на иконку мелодии и перечеркнутой мелодии?

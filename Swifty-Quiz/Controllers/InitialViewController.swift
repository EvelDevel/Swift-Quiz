...
/// В выборе категорий - добавить у каждого тайтла темы справа плюсик, по которому отправлять письмо со "своим вопросом"
/// При запуске на айпаде - логотип в лаунче очень большой, потом становится меньше (перескакивает)

/// ? Сделать рефакторинг сторибордов (не забыл привязать айдишники сигвеев)

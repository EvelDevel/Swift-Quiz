...
// MARK: TODO
/// При выведении алерта в конце - выставлять разные сообщения в зависимости от результата
/// Вынести работу с тенями в отдельный файл (из AbswerButtonsView)
/// Сделать настройки через таблицу
/// Добавить настройку, чтобы после неправильного ответа всплывала подсказка
